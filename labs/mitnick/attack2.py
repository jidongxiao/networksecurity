...
send_ack_packet(source_ip, destination_ip, source_port_first, destination_port_first, syn_ack_seq_num, syn_ack_ack_num)
...
send_custom_packet(source_ip, destination_ip, source_port_first, destination_port_first, syn_ack_seq_num, syn_ack_ack_num, tcp_payload)
